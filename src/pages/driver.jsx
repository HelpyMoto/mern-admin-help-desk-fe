  ...
  return (
    ...
    <div className="px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Driver Ticket</h2>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 w-4/5 sm:mt-20">
        <div className="grid grid-cols-3 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="driver_ID" className="block text-sm font-semibold leading-6 text-gray-900">
            Driver ID
            </label>
            <div className="mt-2.5">
              <input
...
/>
  ...
  <input list="typesOfServices" name="typesOfService" id="typesOfService" placeholder='Round Trip' className="block w-full rounded-md border-0 px-3.5 py-1.5 text-neutral-950 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
/>
