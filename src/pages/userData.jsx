...
export default function UserData() {
  ...
  const onSearch = async (e) => {
    ...
    try {
      ...
      const data = searchData.user.filter((element) => element.role === "user");
      // console.log(data);
      if (res.status === 201) {
        // setSearch("");
        onSearchRender(data);
        ...
        <div className="bg-gray-300 p-5 mt-5">
          <div className="grid grid-rows-2 bg-white p-5">
            ...
            <div className="flex w-full col-span-3 items-center justify-evenly mt-3">
              ...
              <button
                className="bg-green hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2 w-full"
                onClick={handleSearchExport}
              >
                Export
              </button>
              <button
                className="bg-red hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2 w-full"
